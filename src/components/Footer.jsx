      ...
      <div className='container mx-auto flex flex-col md:flex-row justify-between items-start'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
            ...
            <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit amet, consectetur 
                Porro minus harum inventore nihil animi,and
                 excepturi est architecto officiis possimu</p>
            </div>
        ...
        <h3 className='text-white text-lg font-bold 
            ...
            <p className='text-gray-400 max-w-80 mb-4'>The latest news, article, and resources, send to your
                 inbox weekly.</p>
